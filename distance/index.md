...
* Την πρώτη φορά που θα συνδεθείτε μπορείτε να **δημιουργήσετε λογαριασμό με το ionio.gr email σας, όπου θα φαίνεται το ONOMA KAI TO ΑΜ σας και να κάνετε εγκατάσταση του λογισμικού σε έναν επιτραπέζιο υπολογιστή**.
