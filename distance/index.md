...
* Την πρώτη φορά που θα συνδεθείτε μπορείτε να **δημιουργήσετε λογαριασμό όπου θα φαίνεται το όνομα ή/και το ΑΜ σας και να κάνετε εγκατάσταση του λογισμικού σε έναν επιτραπέζιο υπολογιστή**.
