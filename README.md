## Πρόλογος
Για την υλοποίηση της κάθε άσκησης ισχύουν τα εξής: 
...
Στη συνέχεια, σε κάθε υποβολή παραδοτέου, θα πρέπει στα σχόλια του αντίστοιχου **pull request** να συμπεριλαμβάνετε στα **λατινικά**: τον **Α.Μ.**, το **ονοματεπώνυμό** σας, καθώς και τον **τίτλο του μαθήματος**.
