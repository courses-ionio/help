...
* Η συνεργασία ολοκληρώνεται τις δύο τελευταίες εβδομάδες του μαθήματος με τον **σχολιασμό που θα κάνετε σε δύο τουλάχιστον αιτήματα ενσωμάτωσης συμφοιτητών πέρα από την ομάδα σας για την τελική αναφορά**.

* Τα σχόλια-αξιολογήσεις που κάνετε στις κεντρικές συζητήσεις θα πρέπει να είναι προς φοιτητές πέρα από αυτούς της ομάδας σας.
