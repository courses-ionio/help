...
Αν και το σύστημα Github Pages επιτέπει δοκιμές και εκτέλεση των εργασιών που βασίζονται σε client-side javascript προτείνουμε την χρήση κάποιου τοπικού web server ή/και την χρήση κάποιας υπηρεσίας εκτέλεσης javascript, [jsfiddle](https://jsfiddle.net/)
